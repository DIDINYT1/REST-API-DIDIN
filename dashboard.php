...
<html lang="en"  class="height-full">
  <head>
    ...
    <title>Angga-Apis</title>
    <meta property="og:site_name" name="og:site_name" content="ARNZ APIs">
    <meta property="og:title" name="og:title" content="ARNZ - REST APIs">
    <meta property="og:url" name="og:url" content="https://arnz-api.herokuapp.com/">
  ...
  <div class="wrapper">
    <div class="sidebar">
      <div class="sidebar-wrapper">
        ...
        <ul class="nav">
          <li>
            <a href="http://wa.me/6285283427860">
      ...
      <footer class="footer">
        <div class="container-fluid">
          ...
          <div class="copyright">
            ...
            </script>2021 made with <i class="tim-icons icon-heart-2"></i> by
            <a href="javascript:void(0)" target="_blank">AnggaXc</a> for a better web.
          </div>
        </div>
      </footer>
    </div>
    ...
    <div class="dropdown show-dropdown">
      ...
      <ul class="dropdown-menu">
        ...
        <li class="button-container">
          ...
          <a href="https://wa.me/6285283427860?text=Hallo%20bang" target="_blink" class="btn btn-success btn-block btn-round">Whatsapp</a>
        </li>
      </ul>
    </div>
  </div>
